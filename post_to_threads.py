...
GITHUB_RAW_BASE = "https://raw.githubusercontent.com/headmkyoto-star/aya-seunous-threads/main/"
GITHUB_API_BASE = "https://api.github.com/repos/headmkyoto-star/aya-seunous-threads/contents/"
...
def generate_post():
    ...
    prompt = f"""京都祇園のリラクゼーションサロン「あやセウノウス」の若い女性セラピストとして、Threadsの短い営業投稿を作成してください。
